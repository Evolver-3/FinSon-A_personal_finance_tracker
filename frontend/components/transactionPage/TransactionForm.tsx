...
import Wrapper from '../WrapperPage'
...
const TransactionForm = ({ initialValues,
   ...
   const {isDark}=useTheme()
    ...
    const [title,setTitle]=useState(initialValues?.title ?? "")
      ...
      const handleSubmit=async()=>{
        ...
        onSubmit({title,amount,type,note,accountId,categoryId,date})
          setTitle("")
          setAmount("")
          setType("EXPENSE")
          setNote("")
  ...
  return (
    <View className="relative flex-col gap-y-5">
          ...
          errorMessage={error}/>
           ...
           <TextData
            ...
            <View className='items-center justify-center mainborder rounded-lg'>
              <View className="flex-row gap-x-3 p-1 py-1 mainbg rounded-lg"
              style={{
                elevation:2
              }}>
              <SelectType
